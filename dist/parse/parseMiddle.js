...
exports.parseMiddle = void 0;
const parseSmall_1 = require("./parseSmall");
function parseMiddle(text) {
    const match = /(?:([^萬万]*)[萬万])?([零０0])?(.*)?/.exec(text);
    if (!match) {
        return undefined;
    }
    const tenThousandText = match[1];
    const tenThousandValue = tenThousandText !== undefined
        ? tenThousandText
            ? (0, parseSmall_1.parseSmall)(tenThousandText)
            : 1
        : 0;
    ...
    const unitValue = unitText ? (0, parseSmall_1.parseSmall)(unitText) : 0;
...
exports.parseMiddle = parseMiddle;
//# sourceMappingURL=parseMiddle.js.map